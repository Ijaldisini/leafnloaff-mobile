...
class AdminEditMenuView extends StatefulWidget {
  ...
  const AdminEditMenuView({super.key, required this.menu});

  @override
  State<AdminEditMenuView> createState() => _AdminEditMenuViewState();
}

class _AdminEditMenuViewState extends State<AdminEditMenuView> {
